              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group relative inline-flex size-11 items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white/3 text-muted-foreground transition-colors duration-300 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
                  >
                    <span className="absolute inset-0 rounded-2xl bg-gradient-brand opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                    <span className="absolute inset-px rounded-[15px] bg-[#07101f]/90" />
                    <Icon className="relative z-10 size-4" />

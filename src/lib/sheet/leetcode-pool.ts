...
export const leetcodePool: PoolProblem[] = [
  ...
  },
  {
    ...
    rating: 1000,
    tags: ["two pointers", "data structures"],
  },
  {
    code: "binary-search",
    name: "Binary Search",
  ...
  // Medium ~ 1200-1600
  {
    ...
    rating: 1300,
    tags: ["two pointers", "strings", "hashing"],
  },
  {
    code: "3sum",
    name: "3Sum",
  ...
  {
    code: "kth-largest-element-in-an-array",
  ...
  },
  {
    ...
    rating: 1300,
    tags: ["dfs and similar", "combinatorics"],
  },
  ...
  {
    code: "shortest-path-in-a-grid-with-obstacles-elimination",
